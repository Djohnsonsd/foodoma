...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
    ...
    Route::post('/module/install-module', 'ModuleController@installModule')->name('admin.installModule');
    Route::get('/module/disable-module/{id}', 'ModuleController@diableModule')->name('admin.diableModule');
